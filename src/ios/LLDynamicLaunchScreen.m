...
+ (BOOL)replaceLaunchImage:(nullable UIImage *)replaceImage
    ...
    NSString *filePath = [[[paths objectAtIndex:0] stringByAppendingPathComponent:@"Image"] stringByAppendingFormat:@"%@.png", [NSString stringWithFormat:@"%f",[[NSDate date] timeIntervalSince1970] * 1000]];
    
    // Save image.
    [UIImagePNGRepresentation(replaceImage) writeToFile:filePath atomically:YES];
